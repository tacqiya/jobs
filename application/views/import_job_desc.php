        ...
        <div class="container">
            ...
            <div class="row mt-5">
                <div class="col-md-6 m-auto">
                    <form action="<?= base_url() . ADMIN_URL . '/jd-import'; ?>" method="post" id="import_form" enctype="multipart/form-data">
...
<script>
    $(document).ready(function() {
        ...
        $('#import_form').on('submit', function(event) {
            ...
            // fd.append('file', $('#file')[0].files[0]); //console.log($(this).get(0).files.length); return false;
